const ar = {
  tasks: {
    title: 'مهامي',
    subtitle: 'مهامك الحالية محملة من نظام إدارة المهام.',
    myTasks: 'المهام',
    ...
    notes: 'ملاحظات',
    notesPlaceholder: 'صف باختصار نتيجة المهمة...',
  ...
  finance: {
    ...
    emptyPayslips: 'لا توجد قسائم راتب بعد.',
    download: 'تحميل',
    ...
    deductions: 'الخصومات',
    emptyDeductions: 'لا توجد خصومات.',
    amount: 'المبلغ',
    reason: 'السبب',
    incentives: 'الحوافز',
    emptyIncentives: 'لا توجد حوافز.',
    overtime: 'العمل الإضافي',
    emptyOvertime: 'لا توجد سجلات عمل إضافي.',
    date: 'التاريخ',
    hours: 'الساعات',
    rate: 'المعدل',
  ...
  leaves: {
    ...
    myLeaves: {
      ...
      form: {
        ...
        submitting: 'جاري التقديم...',
        submit: 'تقديم الطلب',
        hourlyTitle: 'إجازة ساعية',
        date: 'التاريخ',
        startTime: 'وقت البدء',
        endTime: 'وقت الانتهاء',
        hourlyReasonPlaceholder: 'سبب الإجازة الساعية...',
        workingHoursError: 'ساعات العمل من 09:00 إلى 17:00.',
        timeOrderError: 'يجب أن يكون وقت البدء قبل وقت الانتهاء.'
      }
    }
  },
  attendance: {
    ...
    noRecords: 'لا توجد سجلات حضور هذا الشهر.',
    filter: {
      present: 'حاضر',
      absent: 'غائب',
      late: 'متأخر',
  ...
  adminDashboard: {
    welcome: 'مرحباً بعودتك، أيها المسؤول',
    subtitle: 'إليك ما يحدث في مؤسستك اليوم.',
    totalEmployees: 'إجمالي الموظفين',
    newHiresMonth: 'المعينون الجدد (شهرياً)',
