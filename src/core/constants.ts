// ── Task status color map (Arabic keys → Tailwind classes) ──
...
// ── Month name map (Arabic → English abbreviation) ──
...
// ── Attendance status map (normalised English key → Arabic / English labels + CSS) ──
