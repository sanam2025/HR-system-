    ...
    <div className="p-6 bg-gray-50 min-h-screen" dir="ltr">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="text-xs text-gray-500 uppercase tracking-wider">Contract Number</label>
          ...
          <div>
            <label className="text-xs text-gray-500 uppercase tracking-wider">Salary</label>
        ...
        <div className="mt-6 pt-6 border-t border-gray-100">
          <label className="text-xs text-gray-500 uppercase tracking-wider">Working Hours</label>
