...
const allApplicants: Applicant[] = [
  ...
  },
  {
    ...
    position: "Web Developer",
    experience: 3,
    skills: [{ name: "React", level: "intermediate" }, { name: "CSS", level: "advanced" }],
    status: "reviewed",
  ...
  },
  {
    ...
    position: "Web Developer",
    experience: 7,
    skills: [{ name: "React", level: "expert" }, { name: "Node.js", level: "expert" }],
    status: "interview",
    ...
    <div className="p-6 bg-gray-50 min-h-screen" dir="ltr">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1 text-sm">
          View and manage all job applicants across all positions
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
          ...
          <p className="text-2xl font-bold text-gray-800 mt-1">{allApplicants.length}</p>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
          ...
          <p className="text-2xl font-bold text-blue-600 mt-1">
            {allApplicants.filter((a) => a.status === "reviewed").length}
          </p>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
          <p className="text-xs text-gray-400 uppercase tracking-wider">Interview</p>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-100 bg-gray-50/30">
                ...
                <th className="text-left px-5 py-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Skills</th>
                ...
                <th className="text-left px-5 py-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Applied Date</th>
