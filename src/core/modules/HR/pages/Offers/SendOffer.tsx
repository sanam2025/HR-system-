...
import { ArrowLeft, User, DollarSign, Calendar, Clock } from 'lucide-react';
...
export const SendOffer = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!form.candidate_id || !form.hour_price || !form.start_date || !form.working_hour_per_day) {
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Send a job offer to a candidate</p>
        </div>
