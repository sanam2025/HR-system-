    ...
    <div className="p-6 bg-gray-50 min-h-screen" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-6">
        <div className="flex gap-3">
          <div className="flex-1 relative">
            ...
            <input 
              type="text" 
              placeholder={t.adminEmployeeSearch?.searchPlaceholder || 'Search by name, role, or department...'}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-5 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">{t.adminEmployeeSearch?.avgRating || 'Avg Rating'}</p>
