...
function PayrollTable({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6" dir={i18n.language === 'ar' ? 'rtl' : 'ltr'}>
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4">
        <h3 className="font-semibold text-gray-800">{t('allPayrollRecords') || 'All Payroll Records'}</h3>
        <button 
        ...
        {isPending ? (t('generating') || 'Generating...') : `${t('generatePayrollFor') || 'Generate Payroll for'} ${currentMonth} ${currentYear}`}
        </button>
    </div>
