          ...
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                {lang === 'ar' ? 'لم يتم إنشاء أي أقسام حتى الآن.' : 'No departments have been created yet.'}
              </p>
            </div>
            <button 
              onClick={() => refetch()}
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">
            {t.adminOrganization?.title || 'Organization Structure'}
          </h1>
          <p className="text-gray-500 mt-1 text-sm">
            {t.adminOrganization?.subtitle || 'Manage departments and organizational hierarchy'}
          </p>
        </div>
      </div>
