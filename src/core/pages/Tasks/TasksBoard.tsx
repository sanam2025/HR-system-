...
import type { Task as ApiTask } from '../../../api/models';
import { Plus, X } from 'lucide-react';
import toast, { Toaster } from 'react-hot-toast';

// ── Types ──────────────────────────────────────────────────────────────────
type Task = ApiTask & { rating: number | null };
  ...
  return (
    <div dir="ltr" style={{ fontFamily: 'inherit' }}>
      ...
      {tasksQuery.isLoading && (
        <div style={{ marginBottom: 16, color: '#4b5563', fontSize: 14 }}>Loading tasks...</div>
      )}
      {tasksQuery.isError && (
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8 }}>
                    <span style={{
                      ...
                      background: task.priority ? priorityDot[task.priority] || '#9ca3af' : '#9ca3af',
                    }} />
